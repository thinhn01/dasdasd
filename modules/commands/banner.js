...
module.exports.run = async function({ api, args, event, permssion }) {
  ...
  const lengthchar = (await axios.get('https://run.mocky.io/v3/12b8e61c-3967-46ea-812a-3a5e197c5d52')).data
  if(args[0] == "find" || args[0] == "tìm"){
    ...
    const alime = (await axios.get('https://run.mocky.io/v3/12b8e61c-3967-46ea-812a-3a5e197c5d52')).data
